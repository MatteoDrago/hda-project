...
for model_name in model_names:
    ...
    # for the configuration of subjects [2,3]. The cycle is kept for convenience in defining the involved names.
    for s in subject:
        print("\n\nSubcjects [2,3]")
        ...
        if model_name == "Convolutional":
            ...
            model = models.Convolutional2DRecurrent((window_size, n_features, 1), n_classes, GPU=GPU, print_info=True)
