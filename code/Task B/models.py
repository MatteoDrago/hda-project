...
def Convolutional2DRecurrent(input_shape, n_classes, print_info = False):
...
def Convolutional1DRecurrent(input_shape, n_classes, print_info = False):
...
def ConvolutionalDeepRecurrent(input_shape, n_classes, print_info = False):
